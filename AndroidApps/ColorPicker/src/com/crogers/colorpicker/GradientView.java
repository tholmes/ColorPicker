...
public class GradientView extends View {
    ...
    private OnSaveColorListener m_saveColorListener;
	...
	public interface OnSaveColorListener {
		void saveColor(int red, int green, int blue);
	}
     ...
     */
    public GradientView(Context cxt, AttributeSet attrs){
     ...
     */
    public GradientView(final Context cxt, AttributeSet attrs,
    ...
    public void setBaseColor(int red, int green, int blue){
    	...
    	m_colors[0] = baseColor;
    	m_colors[1] = Color.BLACK;
    	m_colors[2] = Color.WHITE;
    	m_colors[3] = baseColor;
    	...
    	m_centerPaint.setColor(baseColor);
    	 ...
    	 switch (event.getAction()) {  
         	...
         	case MotionEvent.ACTION_UP: // When finger is released from screen
         		if (m_trackingCenter) {
         			...
         			if (inCenter && m_saveColorListener != null){
         				int color = m_centerPaint.getColor();
         				m_saveColorListener.saveColor(Color.red(color), Color.green(color), Color.blue(color));
         				Toast.makeText(getContext(), "Color Saved!", Toast.LENGTH_LONG).show();
         			}
	...
	void setOnSaveColorListener(OnSaveColorListener listener){
		m_saveColorListener = listener;
	}
